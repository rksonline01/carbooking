...
class Package {
	...
	constructor(){
		this.DbCollection = TABLE_PACKAGES;
	}
	 ...
	 * @return render/json
	 */
	getAllPackageList = (req, res, optionObj) => {
	 ...
	 * @return render/json
	 */
	getPackageCount = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	...
	/**
	 * Function to get Package find one
	 *
	 * @param req As Request Data
	 * @param res As Response Data
	 *
   ...
   */
	...
	/**
	* Function to  update one Package
	*
	* @param req As Request Data
	* @param res As Response Data
	*
	* @return render/json
	*/
	updateOnePackage = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	...
	/**
   * Function to get aggregate package list 
   *
   * @param req As Request Data
   * @param res As Response Data
   *
   * @return render/json
   */
	getAggregatePackageList = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
