 ...
 * @return json
 */
const addEditNotificationTypeValidationRules = (req,res, next) => {
	...
	body('type').notEmpty()
	  ...
	  .custom((value,{req,location,path})=>{
		return NotificationType.findNotificationByType(value,req, res, next).then((type)=>{
 ...
 * @return json
 */
NotificationType.findNotificationByType = (value,req, res, next)=>{
	...
	return new Promise(resolve=>{
		...
		let optionObj = {
			...
			collection: TABLE_NOTIFICATION_TYPES,
			fields: {},
		}
...
module.exports = {
	addEditNotificationTypeValidationRules,
  	validate,
}
