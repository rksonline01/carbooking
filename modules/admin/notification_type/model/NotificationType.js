...
class NotificationType {
	...
	constructor() {
		this.DbCollection = TABLE_NOTIFICATION_TYPES;
	}
	 ...
	 * @return render/json
	 */
	getAllNotificationTypeList = (req, res, optionObj) => {
	 ...
	 * @return render/json
	 */
	getNotificationTypeCount = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	 ...
	 * @return render/json
	 */
	getNotificationTypeFindOne = (optionObj) => {
		optionObj.collection = this.DbCollection;
		return new Promise(resolve => {
   ...
   * @return render/json
   */
	saveNotificationType = (req, res, next, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	...
	* @return render/json
	*/
	updateOneNotificationType = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	...
	* @return render/json
	*/
	deleteOneNotificationType = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
	...
	* @return render/json
	*/
	getAggregateNotificationTypeList = (req, res, optionObj) => {
		optionObj.collection = this.DbCollection
		return new Promise(resolve => {
