...
class PushNotificationModel{
    ...
    constructor() {
        this.db_collection_name = TABLE_PUSH_NOTIFICATIONS;
	 ...
	 * @return render/json
	 */
	getPushNotificationAggregateList = (req, res, optionObj) => {
   ...
   * @return render/json
   */
	savePushNotification = (req, res, optionObj) => {
		optionObj.collection = this.db_collection_name
		return new Promise(resolve => {
     ...
     * @return render/json
     */
	deletePushNotification = (req, res, optionObj) => {
		optionObj.collection = this.db_collection_name;
		return new Promise(resolve => {
     ...
     * @return render/json
     */
	updatePushNotification = (req, res, optionObj) => {
		optionObj.collection = this.db_collection_name;
		return new Promise(resolve => {
