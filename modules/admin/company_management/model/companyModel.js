...
class Company {
	...
	constructor(){
		this.DbCollection = TABLE_COMPANY;
	}
   ...
   * @return render/json
   */
	getAggregateCompanyList = (req, res, optionObj) => {
    ...
    /**
     * 
     * to get detail of company
     */
	CompanyDetails = (req,res,option)=>{
   ...
   * @return render/json
   */
	updateOneCompany = (req, res, optionObj) => {
		return new Promise(resolve => {
			optionObj["collection"] = this.DbCollection
	...
	/**
   	...
   	* @return render/json
   	*/
	 deleteCompany = (req, res, optionObj) => {
		return new Promise(resolve => {
			optionObj["collection"] = this.DbCollection
